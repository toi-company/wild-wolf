...
data modify storage wherewolf: roles append value {id:5,name:"科学者",ur_name:"科学者",view_name:"科学者",color:"dark_green",ur_color:"dark_green",vcondition:scientist,value:0}