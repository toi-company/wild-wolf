...
tellraw @a [{"text":"今回勝利した陣営は、"},{"color":"green","text":"村人陣営"},{"text":"です。"},{"text":"\n今回勝利したプレイヤーは、"},{"color":"green","text":"市民:"},{"selector":"@a[tag=ctz]"},{"text":" "},{"color":"red","text":"狼憑き:"},{"selector":"@a[scores={role=4}]"},{"text":" "},{"text":"です。"}]
...
scoreboard players add @a[scores={role=4}] win_count 1
