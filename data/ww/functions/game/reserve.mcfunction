...
execute if score #reserve_timer_tick temporary matches 0 unless score #reserve_timer temporary matches ..3 as @a at @s run playsound minecraft:block.anvil.land player @s
