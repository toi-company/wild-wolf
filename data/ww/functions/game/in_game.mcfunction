...
# ur
execute as @e[type=marker,name="会議"] at @s if entity @a[distance=0..1] run function ww:role/ur/

# kr
execute as @e[type=marker,name="会議"] at @s if entity @a[distance=0..1] run function ww:role/kr/
